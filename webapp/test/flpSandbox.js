		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "GCOS UI5 TO DO LIST",
									"targetURL": "#gcosui5todolist-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gcosui5todolist-display": {
								"semanticObject": "gcosui5todolist",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gcosui5todolist",
									"url": sap.ui.require.toUrl("gcosui5todolist")
								}
							}
						}
					}
